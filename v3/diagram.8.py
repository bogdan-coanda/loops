...
if __name__ == "__main__":
	...
	'''
	for i,n in enumerate(diagram.nodeByAddress['0000001'].loopBrethren):
		n.cycle.marker = ((i+0)%6)+1 # 1+colormap[0][i] # 
		diagram.makeChain([], [n.cycle])
		
	for i,n in enumerate(diagram.nodeByAddress['000154'].loopBrethren):
