...
#	verific daca inca sunt reachable touched chains
# resetez touched chains
#
# pt fiecare loop availables
#		cat timp am ce extinde (singles)
# 		extind ceva
#			updatez touched chains
#			verific daca inca sunt reachable touched chains
	...
	while singles:
		...
		for each touched chain:
			...
			if chain.avloops is 0:
				...
				singles += chain.single_avloop

		if singles:
			loop = singles.pop()
			extend(loop)
			touched chains += loop.chains
